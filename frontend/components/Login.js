...
const Login = () => {
  return (
    <div className="h-screen w-full gradient-bg-hero">
      ...
      {/* <h1 className="bg-gradient-to-r from-[#5b4e78] via-green-500 to-[#16aa91] text-7xl inline-block text-transparent bg-clip-text font-extrabold">
        Welcome to NFT
      </h1>
